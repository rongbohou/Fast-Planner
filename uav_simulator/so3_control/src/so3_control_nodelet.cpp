...
public:
  SO3ControlNodelet()
      : position_cmd_updated_(false), position_cmd_init_(false), des_yaw_(0),
        des_yaw_dot_(0), current_yaw_(0), enable_motors_(true), // FIXME
...
private:
  ...
  void
  position_cmd_callback(const quadrotor_msgs::PositionCommand::ConstPtr &cmd);
